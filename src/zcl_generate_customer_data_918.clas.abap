...
*   fill internal customer table (itab)
    itab = VALUE #(
      ( customer_uuid = '12DB768C31731EDB97C96DFB942C8C73' id = '0001000200' first_name = 'John' last_name = 'Doe' address = 'Hilton street 345, Minneapolis'
      ...
      ( customer_uuid = '12DB768C31731EDB97C96DFB942C8C66' id = '0002000200' first_name = 'Mike' last_name = 'Lerain' address = 'Main Avenue 1999, New York'
      ...
      ( customer_uuid = '12DB768C31731EDB97C96DFB942C8C44' id = '0003000200' first_name = 'Nikola' last_name = 'Tesla' address = 'Electric Way 101, New York'
